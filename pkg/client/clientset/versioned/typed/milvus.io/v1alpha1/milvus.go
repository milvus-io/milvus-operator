...
type MilvusInterface interface {
	Create(ctx context.Context, milvus *v1alpha1.Milvus, opts v1.CreateOptions) (*v1alpha1.Milvus, error)
	Update(ctx context.Context, milvus *v1alpha1.Milvus, opts v1.UpdateOptions) (*v1alpha1.Milvus, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.Milvus, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.MilvusList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Milvus, err error)
	MilvusExpansion
}
...
func newMilvuses(c *MilvusV1alpha1Client, namespace string) *milvuses {
	return &milvuses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *milvuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Milvus, err error) {
	result = &v1alpha1.Milvus{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("milvuses").
		Name(name).
...
func (c *milvuses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MilvusList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MilvusList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("milvuses").
...
func (c *milvuses) Create(ctx context.Context, milvus *v1alpha1.Milvus, opts v1.CreateOptions) (result *v1alpha1.Milvus, err error) {
	result = &v1alpha1.Milvus{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("milvuses").
...
func (c *milvuses) Update(ctx context.Context, milvus *v1alpha1.Milvus, opts v1.UpdateOptions) (result *v1alpha1.Milvus, err error) {
	result = &v1alpha1.Milvus{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("milvuses").
...
func (c *milvuses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Milvus, err error) {
	result = &v1alpha1.Milvus{}
