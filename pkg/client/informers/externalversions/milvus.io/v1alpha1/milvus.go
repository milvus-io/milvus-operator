	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MilvusV1alpha1().Milvuses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MilvusV1alpha1().Milvuses(namespace).Watch(context.TODO(), options)
			},
		},
		&milvusiov1alpha1.Milvus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *milvusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&milvusiov1alpha1.Milvus{}, f.defaultInformer)
}
