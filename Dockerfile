...
RUN wget https://github.com/milvus-io/milvus-helm/raw/${MILVUS_HELM_VERSION}/charts/milvus/charts/kafka-15.5.1.tgz -O ./kafka.tgz
...
RUN tar -xf ./kafka.tgz -C ./out/config/assets/charts/
