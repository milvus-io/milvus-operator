...
VERSION ?= 0.7.4
TOOL_VERSION ?= 0.1.1
MILVUS_HELM_VERSION ?= milvus-3.3.6
...
docker-prepare: build-release out/config/assets/templates
	...
	wget https://github.com/milvus-io/milvus-helm/raw/${MILVUS_HELM_VERSION}/charts/milvus/charts/minio-8.0.14.tgz -O ./minio.tgz
...
sit-prepare-images: sit-prepare-operator-images
	...
	docker pull milvusdb/milvus:v2.2.2
...
sit-load-images: sit-load-operator-images
	@echo "Loading images"
	kind load docker-image milvusdb/milvus:v2.2.2
