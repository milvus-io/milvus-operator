...
```shell
kubectl apply -f https://raw.githubusercontent.com/milvus-io/milvus-operator/v0.6.5/deploy/manifests/deployment.yaml
```
...
Versions, v2.1.2 `[1]`, 2.8.2 / 3.1.0, 3.5.0, RELEASE.2022-03-17T06-34-49Z -->
