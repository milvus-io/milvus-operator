...
Versions, v2.2.7 `[1]`, 2.8.2 / 3.1.0, 3.5.5-2, RELEASE.2023-03-20T20-16-18Z -->
...
```shell
kubectl apply -f https://raw.githubusercontent.com/milvus-io/milvus-operator/v0.7.11/deploy/manifests/deployment.yaml
```
