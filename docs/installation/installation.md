...
```shell
kubectl apply -f https://github.com/milvus-io/milvus-operator/v0.7.7/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/milvus-io/milvus-operator/v0.7.7/deploy/manifests/deployment.yaml
```
