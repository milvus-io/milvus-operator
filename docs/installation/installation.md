...
```shell
kubectl apply -f https://github.com/milvus-io/milvus-operator/v0.7.11/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/milvus-io/milvus-operator/v0.7.11/deploy/manifests/deployment.yaml
```
