...
# change it if you use different client-go version, client-go 0.24+ not compatible with 0.23-
export CLIENT_GO_VERSION=v0.21.7
...
(
  ...
  cd "$(dirname "${0}")"/..
  GO111MODULE=on go install k8s.io/code-generator/cmd/{defaulter-gen,client-gen,lister-gen,informer-gen,deepcopy-gen}@${CLIENT_GO_VERSION}
)
