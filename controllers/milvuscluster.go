...
func (r *MilvusClusterReconciler) ReconcileAll(ctx context.Context, mc v1alpha1.MilvusCluster) error {
	...
	g.Go(WarppedReconcileFunc(r.ReconcileMilvusComponents, gtx, mc))
...
func (r *MilvusClusterReconciler) ReconcileMilvusComponents(ctx context.Context, mc v1alpha1.MilvusCluster) error {
