...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MixCoord) DeepCopyInto(out *MixCoord) {
	*out = *in
	in.Component.DeepCopyInto(&out.Component)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MixCoord.
func (in *MixCoord) DeepCopy() *MixCoord {
	if in == nil {
		return nil
	}
	out := new(MixCoord)
